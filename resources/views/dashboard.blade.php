<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 grid gap-6">
        ...
        {{-- Users images --}}
        <div class="grid-cols-2 justify-start sm:rounded-lg p-3 bg-zinc-700">
            <button class="p-6 bg-indigo-300 overflow-hidden rounded-lg font-bold text-gray-900 mb-3 w-full text-left flex justify-between" onclick="toggleSection('user-images-section')"><p>.your images</p><span id="collapse_icon" class="material-symbols-outlined">collapse_content</span><span id="expand_icon" class="material-symbols-outlined hidden">expand_content</span></button>
            <div id="user-images-section">
